...
local ModelSettings = {
	...
	["BrokenMale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.4, panMaxTop = 0.65, panMaxBottom = -0.80, panValue = 36, zoomMultiplier = 3.7 },
	["BrokenFemale"] = { panMaxLeft = -0.3, panMaxRight = 0.2, panMaxTop = 0.65, panMaxBottom = -0.63, panValue = 38, zoomMultiplier = 3.0 },
	["FelOrcMale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.4, panMaxTop = 0.65, panMaxBottom = -0.80, panValue = 36, zoomMultiplier = 3.7 },
	["FelOrcFemale"] = { panMaxLeft = -0.3, panMaxRight = 0.2, panMaxTop = 0.65, panMaxBottom = -0.63, panValue = 38, zoomMultiplier = 3.0 },
	...
	["Naga_Male"     ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.40, panMaxBottom = -0.16, panValue = 52, zoomMultiplier = 1.8 },
	["Naga_Female"   ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.40, panMaxBottom = -0.15, panValue = 60, zoomMultiplier = 1.5 },
	["ForestTrollMale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.5, panMaxTop = 0.85, panMaxBottom = -0.85, panValue = 30, zoomMultiplier = 3.6 },
	["ForestTrollFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 0.90, panMaxBottom = -0.75, panValue = 33, zoomMultiplier = 3.0 },
	["WorgenMale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.5, panMaxTop = 0.85, panMaxBottom = -0.85, panValue = 30, zoomMultiplier = 3.6 },
	["WorgenFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 0.90, panMaxBottom = -0.75, panValue = 33, zoomMultiplier = 3.0 },
	["SkeletonMale"   ] = { panMaxLeft = -0.6, panMaxRight = 0.6, panMaxTop = 0.95, panMaxBottom = -0.80, panValue = 28, zoomMultiplier = 4.5 },
	["SkeletonFemale" ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.80, panMaxBottom = -0.85, panValue = 31, zoomMultiplier = 3.8 },
	["TaunkaMale"   ] = { panMaxLeft = -0.6, panMaxRight = 0.6, panMaxTop = 0.95, panMaxBottom = -0.80, panValue = 28, zoomMultiplier = 4.5 },
	["TaunkaFemale" ] = { panMaxLeft = -0.3, panMaxRight = 0.3, panMaxTop = 0.80, panMaxBottom = -0.85, panValue = 31, zoomMultiplier = 3.8 },
	["NorthrendSkeletonMale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.5, panMaxTop = 0.85, panMaxBottom = -0.85, panValue = 30, zoomMultiplier = 3.6 },
	["NorthrendSkeletonFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 0.90, panMaxBottom = -0.75, panValue = 33, zoomMultiplier = 3.0 },
	["IceTrollMale"  ] = { panMaxLeft = -0.5, panMaxRight = 0.5, panMaxTop = 0.85, panMaxBottom = -0.85, panValue = 30, zoomMultiplier = 3.6 },
	["IceTrollFemale"] = { panMaxLeft = -0.4, panMaxRight = 0.4, panMaxTop = 0.90, panMaxBottom = -0.75, panValue = 33, zoomMultiplier = 3.0 },
};
