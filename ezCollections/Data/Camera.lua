...
ezCollections.RaceToCameraID =
{
	...
	Naga_                = 13 *   100000,
	Broken                = 14 *   100000,
	ForestTroll                = 15 *   100000,
	Worgen                = 16 *   100000,
	Skeleton                = 17 *   100000,
	Taunka                = 19 *   100000,
	NorthrendSkeleton              = 20 *   100000,
	IceTroll              = 21 *   100000,
};
...
local function WeaponCamera(option, race, sex, invType, subType)
    local subTypeModifier = (subType and (subType + 1) or 0) * ezCollections.SubClassToCameraID;
    return option + race + sex + invType + subTypeModifier;
end
function ezCollections:GetWeaponCameraID(invTypeName, subType, cameraID)
    ...
    if cameraID then
        local fullCameraID = WeaponCamera(option, race, sex, cameraID, subType)
        if ezCollections.Cache.Cameras[fullCameraID] then
            return -fullCameraID
        end
    end
    ...
    local invType = self.InvTypeToCameraID[invTypeName]
    local cameraID = WeaponCamera(option, race, sex, invType, subType)
    if self.Cameras[cameraID] then
        return cameraID
    else
        return self.InvTypeToCameraID[invTypeName]  -- Default fallback if no specific camera setting found
    end
end
...
-- 2.5, -0.6, -0.9, 2.85, 124 zoom,L/R,U/D,rotation zoom,l/r,u/d,rot l/r, rot u/d
ezCollections.Cameras =
{
	--HUMAN WEAPONS
	--1HAND
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_MACE1H)] = {27.90, -0.11, 6.78, 1.90, 111},
    [WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_AXE1H)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_SWORD1H)] = {27.90, -0.11, 6.66, 1.90, 111},
    [WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_FIST 	)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_DAGGER)] = {27.90, -0.11, 6.78, 1.90, 111},
    --MAINHAND--
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPONMAINHAND, LE_ITEM_WEAPON_SWORD1H)] = {27.90, -0.11, 6.66, 1.90, 111},
    [WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPONMAINHAND, LE_ITEM_WEAPON_FIST 	)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPONMAINHAND,  LE_ITEM_WEAPON_DAGGER	)] = {27.90, -0.11, 6.78, 1.90, 111},
	--RANGED--
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_RANGEDRIGHT, LE_ITEM_WEAPON_CROSSBOW	)] = {21.90, 0.15, 6.40, 1.90, 111},
    [WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_RANGEDRIGHT, LE_ITEM_WEAPON_WAND	)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_THROWN	)] = {21.90, 0.15, 6.40, 1.90, 111},
	--2HAND--
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_STAFF)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_AXE1H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_AXE2H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_MACE2H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_SWORD2H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_POLEARM)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_FISHINGPOLE)] = {27.50, -0.11, 6.66, 1.90, 111},
	--OFFHAND--
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPONOFFHAND, LE_ITEM_WEAPON_DAGGER	)] = {27.50, -0.11, 6.66, 1.90, 111},
    [WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPONOFFHAND, LE_ITEM_WEAPON_SWORD1H 	)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_WEAPONOFFHAND,  LE_ITEM_WEAPON_FIST	)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_SHIELD)] = {27.90, 0.51, 7.06, -1.30, 105},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_HOLDABLE)] = {27.50, -0.11, 6.66, 1.90, 105},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_RANGED)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Human, S.Male, I.INVTYPE_HOLDABLE, LE_ITEM_WEAPON_MISC)] = {27.50, -0.11, 6.66, 1.90, 111},
	--end
	
	--1HAND
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_MACE1H)] = {27.90, -0.11, 6.78, 1.90, 111},
    [WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_AXE1H)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_SWORD1H)] = {27.90, -0.11, 6.66, 1.90, 111},
    [WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_FIST 	)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPON, LE_ITEM_WEAPON_DAGGER)] = {27.90, -0.11, 6.78, 1.90, 111},
    --MAINHAND--
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPONMAINHAND, LE_ITEM_WEAPON_SWORD1H)] = {27.90, -0.11, 6.66, 1.90, 111},
    [WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPONMAINHAND, LE_ITEM_WEAPON_FIST 	)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPONMAINHAND,  LE_ITEM_WEAPON_DAGGER	)] = {27.90, -0.11, 6.78, 1.90, 111},
	--RANGED--
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_RANGEDRIGHT, LE_ITEM_WEAPON_CROSSBOW	)] = {21.90, 0.15, 6.40, 1.90, 111},
    [WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_RANGEDRIGHT, LE_ITEM_WEAPON_WAND	)] = {27.90, -0.11, 6.78, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_THROWN	)] = {21.90, 0.15, 6.40, 1.90, 111},
	--2HAND--
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_STAFF)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_AXE1H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_AXE2H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_MACE2H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_SWORD2H)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_POLEARM)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_2HWEAPON, LE_ITEM_WEAPON_FISHINGPOLE)] = {27.50, -0.11, 6.66, 1.90, 111},
	--OFFHAND--
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPONOFFHAND, LE_ITEM_WEAPON_DAGGER	)] = {27.50, -0.11, 6.66, 1.90, 111},
    [WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPONOFFHAND, LE_ITEM_WEAPON_SWORD1H 	)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_WEAPONOFFHAND,  LE_ITEM_WEAPON_FIST	)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_SHIELD)] = {27.90, 0.51, 7.06, -1.30, 105},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_HOLDABLE)] = {27.50, -0.11, 6.66, 1.90, 105},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_RANGED)] = {27.50, -0.11, 6.66, 1.90, 111},
	[WeaponCamera(O.Classic, R.Broken, S.Female, I.INVTYPE_HOLDABLE, LE_ITEM_WEAPON_MISC)] = {27.50, -0.11, 6.66, 1.90, 111},
	...
	[Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_HEAD    )] = {  2.55,  -0.05, -0.75, -0.30 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_SHOULDER)] = {  2.40, -0.30, -0.75, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_CLOAK   )] = {  1.80, -0.10, -0.10,  BACK },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_CHEST   )] = {  2.45,  -0.06, -0.50,  0.00 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_ROBE    )] = {  1.50, -0.05,  0.05,  0.10 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_BODY    )] = {  2.45,  0.00, -0.40,  0.10 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_TABARD  )] = {  2.15,  0.00, -0.20,  0.10 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_WRIST   )] = {  3.00, -0.25, -0.30, -0.35 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_HAND    )] = {  2.85, -0.22, -0.25, -0.50 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_WAIST   )] = {  2.85,  0.02, -0.30,  0.10 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_LEGS    )] = {  2.00, -0.10,  0.20,  0.10 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.INVTYPE_FEET    )] = {  2.45, -0.10,  0.47, -0.70 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.SetsDetails     )] = {  0.00,  0.00, -0.33,  0.00 },
    [Chr(O.Classic,     R.Broken, S.Male,   I.SetsVendor      )] = {  1.25,  0.00, -0.25,  0.00 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_HEAD    )] = {  2.35,  0.03, -0.65, -0.50 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_SHOULDER)] = {  2.45, -0.13, -0.55, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_CLOAK   )] = {  1.30,  0.03,  0.00,  BACK },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_CHEST   )] = {  2.30,  0.03, -0.35, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_ROBE    )] = {  1.20,  0.02,  0.10, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_BODY    )] = {  2.30,  0.03, -0.35, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_TABARD  )] = {  1.95,  0.02, -0.17, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_WRIST   )] = {  2.50, -0.15, -0.15, -0.50 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_HAND    )] = {  2.30, -0.15, -0.10, -0.50 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_WAIST   )] = {  2.40,  0.05, -0.20, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_LEGS    )] = {  1.55,  0.00,  0.25, -0.25 },
    [Chr(O.Classic,     R.Broken, S.Female, I.INVTYPE_FEET    )] = {  2.05,  0.00,  0.55, -0.90 },
    [Chr(O.Classic,     R.Broken, S.Female, I.SetsDetails     )] = {  0.00,  0.03, -0.33,  0.00 },
    [Chr(O.Classic,     R.Broken, S.Female, I.SetsVendor      )] = {  1.00,  0.03, -0.15,  0.00 },
    -- HD2017 zoom,L/R,U/D,rotation
